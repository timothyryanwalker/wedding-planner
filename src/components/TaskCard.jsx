 ...
 * Displays a checkbox, title, owner badge, and due date.
 * Accepts a `task` object and an `onToggle(id)` callback.
 * task shape: { id, title, completed, dueDate, owner, category }
 */
    ...
    <>
      ...
      <div className={`task-card${task.completed ? ' task-card--done' : ''}`}>
        ...
        <div className="task-card__meta">
          <span
            className="task-card__owner"
            style={{ background: ownerStyle.background, color: ownerStyle.color }}
          >
            {task.owner}
          </span>
